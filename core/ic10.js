...
exports.IC10 = void 0;
var IC10Data = {
    __add: function (name, type, preview, ru, en, op1, op2, op3, op4) {
        ...
        if (op4 === void 0) { op4 = null; }
        IC10Data[name] = Object.assign({
            type: "function",
            op1: null,
            op2: null,
            op3: null,
...
var IC10 = /** @class */ (function () {
    ...
    IC10.prototype.getHover = function (name, lang) {
        ...
        if (IC10Data.hasOwnProperty(name)) {
            ...
            if (data === null || data === void 0 ? void 0 : data.description.hasOwnProperty(lang)) {
