...
function run() {
	...
	var snippets = JSON.parse(fs.readFileSync(`..\\snippets\\ic10.json`).toString())
	...
	var tmLanguage10 = JSON.parse(fs.readFileSync(`..\\syntaxes\\ic10.tmLanguage.json`).toString())
	...
	var tmLanguagex = JSON.parse(fs.readFileSync(`..\\syntaxes\\icX.tmLanguage.json`).toString())
