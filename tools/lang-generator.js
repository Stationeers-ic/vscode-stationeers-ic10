...
var IC10Data = {
    ...
    __add: function (lang = null, name = null, type = null, preview = null, text = null, op1 = null, op2 = null, op3 = null, op4 = null) {
        ...
        if (name in IC10Data['Languages']['en']) {
            return this;
        }
        ...
        IC10Data['Languages']['en'][name] = {
            ...
            op4: op4 ? op4 : null,
            description: {
                'preview': translate(preview, lang),
...
IC10Data
    ...
    .__add('ru', 'alias', 'Function', 'op2 => op1', 'Задать псевдоним для регистра или канала данных', 'N', 'R/D', null)
...
function run() {
    ...
    for (const languagesKey in IC10Data.Languages) {
        fs_1.default.writeFileSync(`..\\languages\\${languagesKey}.json`, JSON.stringify(IC10Data.Languages[languagesKey]));
    }
    var snippets = JSON.parse(fs_1.default.readFileSync(`..\\snippets\\ic10.json`).toString());
    ...
    fs_1.default.writeFileSync(`..\\snippets\\ic10.json`, JSON.stringify(snippets));
    var tmLanguage10 = JSON.parse(fs_1.default.readFileSync(`..\\syntaxes\\ic10.tmLanguage.json`).toString());
    ...
    fs_1.default.writeFileSync(`..\\syntaxes\\ic10.tmLanguage.json`, JSON.stringify(tmLanguage10));
    var tmLanguagex = JSON.parse(fs_1.default.readFileSync(`..\\syntaxes\\icX.tmLanguage.json`).toString());
    ...
    fs_1.default.writeFileSync(`..\\syntaxes\\icX.tmLanguage.json`, JSON.stringify(tmLanguagex));
    fs_1.default.writeFileSync(`..\\media\\ic10.keyword.json`, JSON.stringify(keyword));
    fs_1.default.writeFileSync(`..\\media\\ic10.functions.json`, JSON.stringify(functions));
    console.timeEnd('generating');
    return true;
}
run();
//# sourceMappingURL=lang-generator.js.map